...
public class AdapterQuote extends BaseAdapter{
    ...
    List<MaskaQuote> maskaList;
    public AdapterQuote(Context nContext, List<MaskaQuote> maskList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View v = View.inflate(nContext,R.layout.activity_maska_quote,null);
        TextView title = v.findViewById(R.id.heading);
        ImageView picture = v.findViewById(R.id.title_splash_screen);
        TextView descript = v.findViewById(R.id.description);

        MaskaQuote quoteMask = maskaList.get(position);
        ...
        if (quoteMask.getImage().toString().equals("null")){
            picture.setImageResource(R.drawable.picture_zagl);
        }
        else
        {
